...
def face_comparison(upload_img, db_path, d1):
    print(upload_img)
    print(db_path)
    print(d1)
    if os.path.exists("static/representations_facenet.pkl"):
        os.remove("static/representations_facenet.pkl")
    # dict1 = {}
